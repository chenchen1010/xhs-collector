...
# 目标表格
TABLE_URL = "https://gcn6bvkburhk.feishu.cn/base/L5yObKSElaxLxUsmgM7cwR2unyd?table=tblwDly8JAMpzhmA&view=vewYP6e30Y"
...
def test_user_notes():
    if not USER_URL:
        print("\n❌ 请先设置博主主页链接！")
        print("在脚本中修改 USER_URL 变量，例如：")
        print('USER_URL = "https://www.xiaohongshu.com/user/profile/67441cf7000000001c018939"')
        sys.exit(1)
